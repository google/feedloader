...
# This script is for testing purposes. It cleans up buckets and tables,
# automates the upload of feed files to Cloud Storage, waits 200 seconds,
# and uploads an EOF file to initiate Feedloader processing of the feed files.
