...
CreateTrigger deploy_functions_calculate_product_changes.yaml \
  ...
  _FEED_SCHEMA_CONFIG_FILENAME="$FEED_SCHEMA_CONFIG_FILENAME"::_CLOUD_FUNCTION_NAME="$CALCULATE_PRODUCT_CHANGES_FUNCTION_NAME"::_GCP_PROJECT="$GCP_PROJECT"::_TIMEZONE_UTC_OFFSET="$TIMEZONE_UTC_OFFSET"::_EXPIRATION_THRESHOLD="$EXPIRATION_THRESHOLD"::_BQ_DATASET="$BQ_FEED_DATASET"::_DELETES_THRESHOLD="$DELETES_THRESHOLD"::_UPSERTS_THRESHOLD="$UPSERTS_THRESHOLD"::_UPDATE_BUCKET="$UPDATE_BUCKET"::_RETRIGGER_BUCKET="$RETRIGGER_BUCKET"::_FEED_BUCKET="$FEED_BUCKET"::_ARCHIVE_BUCKET="$ARCHIVE_BUCKET"::_COMPLETED_FILES_BUCKET="$COMPLETED_FILES_BUCKET"::_LOCK_BUCKET="$LOCK_BUCKET"
CreateTrigger deploy_functions_import_file_into_bq.yaml \
  "FeedLoader Deploy Feed Import Function" \
  _FEED_SCHEMA_CONFIG_FILENAME="$FEED_SCHEMA_CONFIG_FILENAME"::_CLOUD_FUNCTION_NAME="$FEED_IMPORT_FUNCTION_NAME"::_BQ_DATASET="$BQ_FEED_DATASET"::_COMPLETED_FILES_BUCKET="$COMPLETED_FILES_BUCKET"::_FEED_BUCKET="$FEED_BUCKET"::_UPDATE_BUCKET="$UPDATE_BUCKET"::_LOCK_BUCKET="$LOCK_BUCKET"
CreateTrigger deploy_functions_retry_feed_import.yaml \
  "FeedLoader Deploy Feed File Retry Function" \
  _FEED_SCHEMA_CONFIG_FILENAME="$FEED_SCHEMA_CONFIG_FILENAME"::_CLOUD_FUNCTION_NAME="$FEED_RETRY_FUNCTION_NAME"::_BQ_DATASET="$BQ_FEED_DATASET"::_FEED_BUCKET="$FEED_BUCKET"::_UPDATE_BUCKET="$UPDATE_BUCKET"::_COMPLETED_FILES_BUCKET="$COMPLETED_FILES_BUCKET"::_RETRIGGER_BUCKET="$RETRIGGER_BUCKET"
CreateTrigger deploy_functions_trigger_dag.yaml \
  "FeedLoader Deploy Trigger DAG Function" \
  _CLOUD_FUNCTION_NAME="${TRIGGER_DAG_FUNCTION_NAME}"::_GCP_PROJECT="$GCP_PROJECT"::_AIRFLOW_WEBSERVER_ID="$AIRFLOW_WEBSERVER_ID"::_DAG_ID="$DAG_ID"::_TRIGGER_COMPLETION_BUCKET="$TRIGGER_COMPLETION_BUCKET"::_REGION="$REGION"::_CLOUD_COMPOSER_ENV_NAME="$CLOUD_COMPOSER_ENV_NAME"
...
then
  ...
  CreateTrigger deploy_functions_calculate_product_changes.yaml \
    "[LOCAL] FeedLoader Deploy Calculate Product Change Function" \
    _CLOUD_FUNCTION_NAME="${CALCULATE_PRODUCT_CHANGES_FUNCTION_NAME}_local"::_FEED_SCHEMA_CONFIG_FILENAME="$FEED_SCHEMA_CONFIG_FILENAME_LOCAL"::_GCP_PROJECT="$GCP_PROJECT"::_TIMEZONE_UTC_OFFSET="$TIMEZONE_UTC_OFFSET"::_EXPIRATION_THRESHOLD="$EXPIRATION_THRESHOLD"::_BQ_DATASET="$BQ_FEED_DATASET_LOCAL"::_DELETES_THRESHOLD="$DELETES_THRESHOLD"::_UPSERTS_THRESHOLD="$UPSERTS_THRESHOLD"::_UPDATE_BUCKET="$UPDATE_BUCKET_LOCAL"::_RETRIGGER_BUCKET="$RETRIGGER_BUCKET_LOCAL"::_FEED_BUCKET="$FEED_BUCKET_LOCAL"::_ARCHIVE_BUCKET="$ARCHIVE_BUCKET_LOCAL"::_COMPLETED_FILES_BUCKET="$COMPLETED_FILES_BUCKET_LOCAL"::_LOCK_BUCKET="$LOCK_BUCKET_LOCAL"
  CreateTrigger deploy_functions_import_file_into_bq.yaml \
    "[LOCAL] FeedLoader Deploy Feed Import Function" \
    _CLOUD_FUNCTION_NAME="${FEED_IMPORT_FUNCTION_NAME}_local"::_FEED_SCHEMA_CONFIG_FILENAME="$FEED_SCHEMA_CONFIG_FILENAME_LOCAL"::_BQ_DATASET="$BQ_FEED_DATASET_LOCAL"::_COMPLETED_FILES_BUCKET="$COMPLETED_FILES_BUCKET_LOCAL"::_FEED_BUCKET="$FEED_BUCKET_LOCAL"::_UPDATE_BUCKET="$UPDATE_BUCKET_LOCAL"::_LOCK_BUCKET="$LOCK_BUCKET_LOCAL"
  CreateTrigger deploy_functions_retry_feed_import.yaml \
    "[LOCAL] FeedLoader Deploy Feed File Retry Function" \
    _CLOUD_FUNCTION_NAME="${FEED_RETRY_FUNCTION_NAME}_local"::_FEED_SCHEMA_CONFIG_FILENAME="$FEED_SCHEMA_CONFIG_FILENAME_LOCAL"::_BQ_DATASET="$BQ_FEED_DATASET_LOCAL"::_FEED_BUCKET="$FEED_BUCKET_LOCAL"::_UPDATE_BUCKET="$UPDATE_BUCKET_LOCAL"::_COMPLETED_FILES_BUCKET="$COMPLETED_FILES_BUCKET_LOCAL"::_RETRIGGER_BUCKET="$RETRIGGER_BUCKET_LOCAL"
  CreateTrigger deploy_functions_trigger_dag.yaml \
    "[LOCAL] FeedLoader Deploy Trigger DAG Function" \
    _CLOUD_FUNCTION_NAME="${TRIGGER_DAG_FUNCTION_NAME}_local"::_GCP_PROJECT="$GCP_PROJECT"::_AIRFLOW_WEBSERVER_ID="$AIRFLOW_WEBSERVER_ID"::_DAG_ID="$DAG_ID"::_TRIGGER_COMPLETION_BUCKET="${TRIGGER_COMPLETION_BUCKET_LOCAL}"::_REGION="$REGION"::_CLOUD_COMPOSER_ENV_NAME="$CLOUD_COMPOSER_ENV_NAME"
fi
